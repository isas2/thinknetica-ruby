...
CursesMenu.new 'Главное управление железной дороги' do |menu|
  menu.item 'Станции' do
    CursesMenu.new 'Управление станциями' do |sub_menu|
      sub_menu.item 'Список станций' do run(:show_stantions) end
      sub_menu.item 'Добавить станцию' do run(:new_stantion) end
      sub_menu.item 'Список поездов на станции' do run(:show_stantion_trains) end
      sub_menu.item '----------------------'
  ...
  menu.item 'Маршруты' do
    CursesMenu.new 'Управление маршрутами движения' do |sub_menu|
      ...
      sub_menu.item 'Добавить в маршрут станцию' do run(:add_route_stantion) end
      sub_menu.item 'Удалить из маршрута станцию' do run(:delete_route_stantion) end
